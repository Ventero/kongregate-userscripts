...
function init_extended_hl_content(loadPref, savePref) {
...
function init_extended_hl() {
  runInScope(init_extended_hl_content, false, "__init_Extended_HL");
  unsafeWindow.__init_Extended_HL(
    exportFunction(loadPref, unsafeWindow),
    exportFunction(savePref, unsafeWindow)
  );
}

runWhenReady(init_extended_hl);
